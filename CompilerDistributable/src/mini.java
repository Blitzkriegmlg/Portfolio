/*
  ...
  Version 3.0 note: reconfigured the app to use command line arguments in
  order to allow for the automation of compiling and running source code.
  Added an option for verbosity. Removed the system exit commands
  and replace with standard return statements for successful endings. 
  - Matthew Benson
...
public class mini{
  ...
  public static boolean verbose;			 // controls amount of terminal output

  public static void run(String args[], boolean isVerbose) throws IOException {
    ...
    do{             // TRANSLATION LOOP                            
      ...
      if(verbose) {System.out.println(SourceLine); }
