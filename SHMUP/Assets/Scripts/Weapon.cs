...
//of a specific weapon in the Inspect. Main has an array
//of WeaponDifinitions that make this possible.
...
public class WeaponDefinition
    {
        ...
        public string letter; //the letter showing the powerup
        public Color color = Color.white; //color of Collar & power-up
        public GameObject projectilePrefab; //prefab for projectiles
        public Color projectileColor = Color.white;
        public float damageOnHit = 0;   //ammount of damage caused
